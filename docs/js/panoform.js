...
function setDefaultPanorama() {
  ...
  el("imgmap").value = '<area shape="rect" alt="Old Part of the Karlsburg Castle" title="" coords="504,12,896,462" href="https://en.wikipedia.org/wiki/Durlach" target="_blank"/>\n<area shape="rect" alt="Newer part of the Karlsburg castle rebuild after fire" title="" coords="1513,4,1969,453" href="https://en.wikipedia.org/wiki/Karlsburg_Castle" target="_blank" />';
};
