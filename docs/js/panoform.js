...
function setDefaultPanorama() {
  ...
  el("imgmap").value = '<area shape="rect" alt="Old Part of the Karlsburg Castle" title="" coords="504,12,896,462" href="javascript:alert(\'Old part of the Karlsburg castle\')" target="" /><area shape="rect" alt="Newer part of the Karlsburg castle rebuild after fire" title="" coords="913,4,2969,453" href="https://en.wikipedia.org/wiki/Karlsburg_Castle" target="_blank" />';
}
